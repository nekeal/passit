...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(default=get_default_field_age_group, on_delete=django.db.models.deletion.PROTECT, related_name='news', to='subject.FieldOfStudyOfAgeGroup'),
