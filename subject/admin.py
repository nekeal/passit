...
from subject.models import Subject, SubjectOfAgeGroup, Exam, Resource, FieldOfStudy, FieldOfStudyOfAgeGroup
...
class SubjectAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request: HttpRequest) -> 'QuerySet[Subject]':
        return super(SubjectAdmin, self).get_queryset(request).select_related('field_of_study')
