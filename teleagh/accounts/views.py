...
from teleagh.accounts.serializers import DefaultFieldOfAgeGroupSerializer, MembershipSerializer
...
class CustomUserViewSet(UserViewSet):
    ...
    @action(methods=['put'], detail=False, url_path='set_default_fag')  # TODO: add permission
    def set_default_field_age_group(self, request, *args, **kwargs):
        ...
        return Response(MembershipSerializer(new_default).data, status=status.HTTP_200_OK)
