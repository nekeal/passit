...
// const announcements = [
//   { id: 1, title: '100 lat AGH!', content: 'Jutro odbędą się uroczyste obchody 100. rocznicy AGH.\nStart - A0 godz. 9:30.', date: '13.09.2020', author: '@AGHOfficial' }
// ];
...
function Dashboard() {
  ...
  return (
    <>
      <TopBar/>
      <DashboardContainer>
        <Link component={RouterLink} to="/terms" className="calendar-link">Kalendarz zaliczeń</Link>
