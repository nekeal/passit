...
def test_created_by_is_set_on_instance(api_rf, student1, file_other_data):
...
def test_modified_by_is_set_on_instance(api_rf, student1, student2, file_other_data, students1_file):
