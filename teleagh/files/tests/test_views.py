...
def test_user_without_profile_cant_access_view(api_rf, file_list_view, user1):
...
def test_user_without_membership_cant_access_view(api_rf, file_list_view, user_profile1):
    request = api_rf.get(reverse('api:file-list'))
...
def test_student_can_access_view(api_rf, file_list_view, student1):
    request = api_rf.get(reverse('api:file-list'))
...
def test_files_are_filtered_by_user(api_rf, student1, student2, students1_file):
...
def test_student_can_create_file_with_other(api_rf, file_list_view, student1, file_other_data):
...
def test_student_can_create_file_with_image(api_rf, file_list_view, student1, file_image_data):
...
def test_owner_can_edit_his_files(api_rf, file_detail_view, student1, students1_file, file_other_data):
...
def test_student_can_delete_his_files(api_rf, file_detail_view, student1, students1_file, file_other_data):
