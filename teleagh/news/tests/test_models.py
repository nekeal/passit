...
def test_get_news_by_profile(user_profile1_with_membership, subject_group):
    ...
    user_news = News.objects.get_by_profile(user_profile1_with_membership)
...
def test_get_news_by_profile_with_multiple_memberships(user_profile1_with_membership, subject_group):
