...
from ...subject.factories import SubjectOfAgeGroupFactory, FieldOfStudyOfAgeGroupFactory


def test_get_news_by_profile(student1, field_age_group):
...
def test_get_news_by_profile_with_multiple_memberships(student1, subject_group):
