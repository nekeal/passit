...
class TestFieldOfAgeGroupSerializer:
    ...
    def test_can_create_field_age_group(self, db, field_age_group_data):
...
class TestResourceSerializer:
    ...
    def test_resource_owned_model_serializer(self, resource_data_without_files, api_rf, user_profile1, user_profile2):
