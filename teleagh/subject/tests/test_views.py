...
class TestResourceViewSet:
    ...
    def test_student_can_create_resource_without_files(self, api_rf, resource_list_view, student1, resource_data_without_files):
    ...
    def test_student_can_create_resource_with_files(self, api_rf, resource_list_view, student1, resource_data_without_files):
    ...
    def test_student_can_create_resource_using_own_files(self, api_rf, resource_list_view, student1, students1_file,
    ...
    def test_student_cant_create_resource_using_someones_files(self, api_rf, resource_list_view, student2, students1_file,
                                                               resource_data_without_files):
        resource_data_without_files['files'] = [students1_file.id]
        request = api_rf.post(reverse('api:file-list'), data=resource_data_without_files)
